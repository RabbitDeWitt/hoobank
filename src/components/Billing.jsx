...
const Billing = () => (
  <section id='product' className={layout.sectionReverse}>
    ...
    <div className={layout.sectionInfo}>
      ...
      <div className='flex flex-row mt-6 sm:mt-10 gap-5'>
        <img src={apple} alt="App Store" className='w-[128px] h-[42px]'/>
        <img src={google} alt="Google Play" className='w-[144px] h-[43px]'/>
      </div>
    </div>
  </section>
)
